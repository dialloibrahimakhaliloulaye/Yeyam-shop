                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="price_status" id="" class="form-control">
                                    ...
                                    <option value="derniere_prix">Dernier prix</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="condition" id="" class="form-control">
                                    ...
                                    <option value="post_paid">Post payer</option>
                                    <option value="pre_paid">pré-payer</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">Lien (youtube) visualisation du produit / service</label>

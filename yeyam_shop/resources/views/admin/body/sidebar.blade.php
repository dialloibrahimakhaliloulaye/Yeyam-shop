        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{($prefix=='/brand')?'active':''}}">
                ...
                <ul class="treeview-menu">
                    <li class="{{($route=='all.brand')?'active':''}}"><a href="{{route('all.brand')}}"><i class="ti-more"></i>Toutes les Brands</a></li>
                </ul>
            </li>
            @else
            @endif

        ...
        <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{($route=='all.category')?'active':''}}"><a href="{{route('all.category')}}">
                            <i class="ti-more"></i>All category</a></li>
                    <li class="{{($route=='all.subcategory')?'active':''}}"><a href="{{route('all.subcategory')}}">
                            <i class="ti-more"></i>All subcategory</a></li>
            ...
            <li class="treeview {{ ($prefix == '/setting')?'active':'' }}  ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'all.request')? 'active':'' }}">
                        <a href="{{ route('all.request') }}"><i class="ti-more"></i>Seo Setting</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ ($prefix == '/return')?'active':'' }}  ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'seo.setting')? 'active':'' }}">
                        <a href="{{ route('seo.setting') }}"><i class="ti-more"></i>All Request</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ ($prefix == '/review')?'active':'' }}  ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'all.request')? 'active':'' }}">
                        <a href="{{ route('all.request') }}"><i class="ti-more"></i>Publish Review</a>
                    </li>
                </ul>
            </li>

                                                ...
                                                @foreach($reviews as $item)
                                                    ...
                                                    @else
                                                        <div class="review">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <img style="border-radius: 50%" src="{{ (!empty($item->user->profile_photo_path))?
                                                            ...
                                                            <div class="review-title"><span class="summary">{{ $item->summary }}</span><span class="date">
                                                                    <i class="fa fa-calendar"></i><span> {{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }}
                                                                    </span></span></div>
                                            ...
                                            <div class="review-form">
                                                ...
                                                @else
                                                    <div class="form-container">
                                                        ...
                                                        <form role="form" class="cnt-form" method="post" action="{{ route('review.store') }}">@csrf
                                        ...
                                        <div class="product-info text-left">
                                            ...
                                            @else
                                                <div class="product-price">
                                                    ...
                                                    <span
                                                        class="price-before-discount">{{$product->selling_price}} FCFA</span>
                                                </div>
                                            @endif
                                            ...
                                            <div class="action">
                                                <ul class="list-unstyled">
                                                    <li class="add-cart-button btn-group">
                                                        ...
                                                        <button class="btn btn-primary cart-btn" type="button">Ajouter au Panier
                                                        </button>

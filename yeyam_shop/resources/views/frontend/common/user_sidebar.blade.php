...
url('upload/user_images/'.$user->profile_photo_path):url('upload/no_image.jpg') }}" height="100%" width="100%"><br><br>
    ...
    <ul class="list-group list-group-flush">
        ...
        <a href="{{ route('return.order.list') }}" class="btn btn-primary btn-sm btn-block">Retour Commandes</a>

        <a href="{{ route('cancel.orders') }}" class="btn btn-primary btn-sm btn-block">Commandes annulées</a>

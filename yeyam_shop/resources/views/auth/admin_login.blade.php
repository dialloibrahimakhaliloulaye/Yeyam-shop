            ...
            <div class="row justify-content-center no-gutters">
                <div class="col-lg-4 col-md-5 col-12">
                    <div class="content-top-agile p-10">
                        ...
                        <p class="text-white-50">Saisissez les bonnes coordonnées pour vous connecter</p>
                    </div>
                    <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="checkbox text-white">
                                        ...
                                        <label for="basic_checkbox_1">Se souvénir</label>
                                    </div>
                                </div>
                                <!-- /.col -->
                                <div class="col-6">
                                    <div class="fog-pwd text-right">
                                        <a href="{{route('password.request')}}" class="text-white hover-info"><i class="ion ion-locked"></i>Mot de passe oublié</a><br>
                                    </div>
                                </div>
                                <!-- /.col -->
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn btn-info btn-rounded mt-10">SE CONNECTER</button>
                                </div>
                                <!-- /.col -->
                            </div>
                        </form>
                        ...
                        <div class="text-center text-white">
                            <p class="mt-20">- Se connecter avec -</p>
                        ...
                        <div class="text-center">
                            <p class="mt-15 mb-0 text-white">Pas de compte ? <a href="auth_register.html" class="text-info ml-5">S'inscrire</a></p>
                        </div>
                    </div>
                </div>
            </div>
